...
severity: high
sourceCount: 1
tags: ["vendor-compromise", "oauth-token-theft", "third-party-integration"]
---
...
1. https://klue.com/blog/an-update-on-recent-klue-security-incident — **Source** — supports the incident facts cited above; limitations are noted where technical detail is absent.
