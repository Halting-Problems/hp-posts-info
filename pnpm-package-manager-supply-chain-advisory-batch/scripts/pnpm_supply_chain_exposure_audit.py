...
VULNERABLE_VERSION_RANGES = [
    "pnpm <10.33.4 for GitHub codeload tarball lockfile hash omission",
    "pnpm >=11.0.0 <11.0.7 for GitHub codeload tarball lockfile hash omission",
    "pnpm <10.34.0 or >=11.0.0 <11.4.0 for default integrity repair, git fetch argument injection, alias path traversal, credential binding, and patch traversal advisories",
    "pnpm <10.34.1 or >=11.0.0 <11.4.0 for missing lockfile integrity fail-open behavior",
    "pnpm <10.34.2 or >=11.0.0 <11.5.3 for repository .npmrc environment-secret expansion into registry requests",
]
PACKAGE_VERSION_IOCS = ["pnpm < 10.34.2", "pnpm >= 11.0.0"]
...
def main(argv: list[str]) -> int:
    ...
    output = {
        ...
        "package_version_iocs": PACKAGE_VERSION_IOCS,
