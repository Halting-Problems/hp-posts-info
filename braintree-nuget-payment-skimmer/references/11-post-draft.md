...
1. **Socket**: https://socket.dev/blog/braintree-nuget-typosquat-skims-credit-cards — primary technical research supporting package, behavior, timeline, and IOC claims; it does not prove the number of affected organizations.
