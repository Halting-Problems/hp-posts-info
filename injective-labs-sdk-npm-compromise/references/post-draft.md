...
1. https://socket.dev/blog/compromised-injective-sdk-npm-package — **Socket** — primary technical research supporting package, behavior, timeline, and IOC claims; it does not prove the number of affected organizations.
2. https://www.stepsecurity.io/blog/injective-npm-supply-chain-attack-18-packages-backdoored-to-steal-crypto-wallet-keys — **StepSecurity** — primary technical research supporting package, behavior, timeline, and IOC claims; it does not prove the number of affected organizations.
