#!/usr/bin/env python3
"""
Auto-generated per-folder tests for: windows-miniplasma-lpe-zero-day
...
def test_script_out_default_is_namespaced():
    ...
    assert "hp-windows-miniplasma-lpe-zero-day-scope" in _load_script_source(), (
        "OUT default does not include 'hp-windows-miniplasma-lpe-zero-day-scope'"
    )
