...
1. **Socket**: https://socket.dev/blog/npm-pypi-campaign-typosquats-popular-secure-payment-apps — primary technical research supporting package, behavior, timeline, and IOC claims; it does not prove the number of affected organizations.
